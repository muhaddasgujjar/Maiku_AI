...
- [x] Create `assets/icon.ico` (256×256 ICO) for installer icon — dark navy + teal "M", generated by scripts/make_icon.py
- [x] Pushed to GitHub (MuhammadMuhaddas/maiku-ai) — auto-update via electron-updater enabled when a release is published
- [ ] macOS / Linux testing (Windows 11 tested and working)
